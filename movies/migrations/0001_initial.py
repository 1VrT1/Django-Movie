    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(max_length=30, verbose_name='Старана')),
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='указыват ьсумму в долларах', verbose_name='Сборы в США')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Имя')),
                ('text', models.TextField(max_length=5000, verbose_name='Сообщние')),
